                    ...
                    <div classname="movieDetails">
                        <div className="posterContainer" style={{ paddingTop: '3%' }}>
                            <div className="poster" style={{ borderRadius: 5 }}>
                                <Card>
                                    ...
                                    <CardContent style={{ textAlign: 'justify' }}>
                                        <Button variant="contained" style={{ backgroundColor: "blue", color: "#ffffff" }}>
                            ...
                            <div className="movieInfo" xs={8} style={{ textAlign: 'justify', }}>
                                ...
                                <Divider />
                                <div className="runtime" style={{ color: 'white' }}>
                                    <Button variant="contained" style={{ backgroundColor: "blue", color: "#ffffff" }}>
                                ...
                                <Divider />
                                <div className="schedule" style={{ color: 'white' }}>
                        ...
                        <div style={{ backgroundColor: "#000000", color: "yellow", textAlign: "center", textSizeAdjust: 20 }}>
